...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    "sidebar.section.execution": "Execution",
    ...
    "sidebar.link.projectList": "Project List",
    "sidebar.link.nftWaitlist": "NFT Waitlist",
    "sidebar.link.priority": "Priority",
    "sidebar.link.ecosystem": "Ekosistem",
    "sidebar.link.screening": "Screening",
    "sidebar.link.eligibility": "Eligibility",
    "sidebar.link.liveAirdrop": "Live Airdrop",
    "sidebar.link.faucet": "Faucet",
    "sidebar.link.multiAccount": "Accounts",
    "sidebar.link.rewardVault": "Reward Vault",
    "sidebar.link.calculator": "Calculator",
    "sidebar.link.tradingPlan": "Trading Plan",
    "sidebar.link.portfolioManager": "Portfolio",
    "sidebar.link.liveGasFee": "Gas Fees",
    "sidebar.link.tools": "Directory",
    "sidebar.link.deploy": "Deploy Tools",
    "sidebar.link.swapBridge": "Swap & Bridge",
    "sidebar.link.aiTools": "AI Tools",
    "sidebar.link.researchProject": "Project Research",
    "sidebar.link.sybilDetector": "Sybil Check",
    ...
    "topbar.section.projectList": "Project List",
    "topbar.section.nftWaitlist": "NFT Waitlist",
    ...
    "topbar.section.liveAirdrop": "Live Airdrop",
    "topbar.section.faucet": "Faucet",
    "topbar.section.multiAccount": "Accounts",
    "topbar.section.rewardVault": "Reward Vault",
    "topbar.section.calculator": "Calculator",
    "topbar.section.tradingPlan": "Trading Plan",
    "topbar.section.portfolioManager": "Portfolio",
    "topbar.section.liveGasFee": "Gas Fees",
    "topbar.section.tools": "Directory",
    "topbar.section.deploy": "Deploy Tools",
    ...
    "portfolio.badge": "Manajemen aset",
    "portfolio.title": "Portfolio Manager",
    "portfolio.subtitle": "Kelola pemasukan, pengeluaran, saldo aset, riwayat transaksi, dan kalkulator portofolio dari data Supabase milik akunmu.",
    "portfolio.tab.overview": "Overview",
    "portfolio.tab.income": "Income",
    "portfolio.tab.expense": "Expense",
    "portfolio.tab.assets": "Assets",
    "portfolio.tab.history": "History",
    "portfolio.tab.calculator": "Calculator",
    "portfolio.type.income": "Income",
    "portfolio.type.expense": "Expense",
    "portfolio.metric.totalAssets": "Total Assets",
    "portfolio.metric.totalIncome": "Total Income",
    "portfolio.metric.totalExpense": "Total Expense",
    "portfolio.metric.cashFlow": "Cash Flow",
    "portfolio.metric.netProfit": "Net Profit",
    "portfolio.overview.monthlySummary": "Monthly Summary",
    "portfolio.overview.recentTransactions": "Recent Transactions",
    "portfolio.overview.charts": "Charts",
    "portfolio.chart.assets": "Assets",
    "portfolio.chart.income": "Income",
    "portfolio.chart.expense": "Expense",
    "portfolio.income.formTitle": "Tambah Income",
    "portfolio.income.formDescription": "Catat pemasukan asli tanpa data demo.",
    "portfolio.income.listTitle": "Daftar Income",
    "portfolio.income.emptyTitle": "Belum ada income",
    "portfolio.income.emptyDescription": "Income yang kamu simpan akan muncul di sini.",
    "portfolio.expense.formTitle": "Tambah Expense",
    "portfolio.expense.formDescription": "Catat pengeluaran dari wallet atau akun yang relevan.",
    "portfolio.expense.listTitle": "Daftar Expense",
    "portfolio.expense.emptyTitle": "Belum ada expense",
    "portfolio.expense.emptyDescription": "Expense yang kamu simpan akan muncul di sini.",
    "portfolio.assets.title": "Assets",
    "portfolio.assets.formTitle": "Tambah Asset",
    "portfolio.assets.formDescription": "Lacak saldo cash, bank, stablecoin, dan crypto utama.",
    "portfolio.assets.listTitle": "Saldo Asset",
    "portfolio.assets.emptyTitle": "Belum ada asset",
    "portfolio.assets.emptyDescription": "Tambahkan saldo pertama untuk mulai melihat total assets.",
    "portfolio.assetType.cash": "Cash",
    "portfolio.assetType.bank": "Bank",
    "portfolio.assetType.idr": "IDR",
    "portfolio.assetType.usd": "USD",
    "portfolio.assetType.usdt": "USDT",
    "portfolio.assetType.usdc": "USDC",
    "portfolio.assetType.btc": "BTC",
    "portfolio.assetType.eth": "ETH",
    "portfolio.assetType.sol": "SOL",
    "portfolio.field.date": "Date",
    "portfolio.field.type": "Type",
    "portfolio.field.category": "Category",
    "portfolio.field.currency": "Currency",
    "portfolio.field.amount": "Amount",
    "portfolio.field.wallet": "Wallet",
    "portfolio.field.source": "Source",
    "portfolio.field.note": "Note",
    "portfolio.field.attachment": "Attachment",
    "portfolio.field.actions": "Actions",
    "portfolio.field.assetType": "Asset Type",
    "portfolio.field.label": "Label",
    "portfolio.field.balance": "Balance",
    "portfolio.placeholder.category": "Kategori transaksi",
    "portfolio.placeholder.wallet": "Nama wallet atau akun",
    "portfolio.placeholder.source": "Sumber pemasukan",
    "portfolio.placeholder.note": "Catatan opsional",
    "portfolio.placeholder.attachment": "URL attachment",
    "portfolio.action.add": "Tambah",
    "portfolio.action.newIncome": "Tambah Income",
    "portfolio.action.csv": "CSV",
    "portfolio.action.excel": "Excel",
    "portfolio.action.print": "Print",
    "portfolio.action.previous": "Sebelumnya",
    "portfolio.action.next": "Berikutnya",
    "portfolio.action.undoDelete": "Undo Delete",
    "portfolio.history.title": "History",
    "portfolio.history.description": "Cari, filter, sort, edit, hapus, undo delete, export, dan print transaksi.",
    "portfolio.history.search": "Cari transaksi...",
    "portfolio.history.page": "Halaman {page} dari {total}",
    "portfolio.history.deleted": "Transaksi Dihapus",
    "portfolio.filter.allTypes": "Semua type",
    "portfolio.filter.allCurrencies": "Semua currency",
    "portfolio.sort.date": "Date",
    "portfolio.sort.amount": "Amount",
    "portfolio.sort.category": "Category",
    "portfolio.sort.type": "Type",
    "portfolio.sort.asc": "Naik",
    "portfolio.sort.desc": "Turun",
    "portfolio.export.date": "Date",
    "portfolio.export.type": "Type",
    "portfolio.export.category": "Category",
    "portfolio.export.currency": "Currency",
    "portfolio.export.amount": "Amount",
    "portfolio.export.wallet": "Wallet",
    "portfolio.export.source": "Source",
    "portfolio.export.note": "Note",
    "portfolio.export.attachment": "Attachment",
    "portfolio.empty.monthlyTitle": "Belum ada ringkasan bulanan",
    "portfolio.empty.monthlyDescription": "Ringkasan akan muncul setelah ada transaksi.",
    "portfolio.empty.transactionsTitle": "Belum ada transaksi",
    "portfolio.empty.transactionsDescription": "Tambahkan income atau expense untuk mengisi history.",
    "portfolio.error.title": "Portfolio belum siap",
    "portfolio.error.load": "Gagal memuat portfolio.",
    "portfolio.error.save": "Gagal menyimpan portfolio.",
    "portfolio.toast.required": "Lengkapi field wajib terlebih dahulu.",
    "portfolio.toast.created": "Data portfolio berhasil ditambahkan.",
    "portfolio.toast.updated": "Data portfolio berhasil diperbarui.",
    "portfolio.toast.deleted": "Data portfolio dihapus.",
    "portfolio.toast.undo": "Delete dibatalkan.",
    "portfolio.calculator.basic": "Basic Calculator",
    "portfolio.calculator.percentage": "Percentage",
    "portfolio.calculator.pnl": "Profit & Loss",
    "portfolio.calculator.roi": "ROI",
    "portfolio.calculator.compound": "Compound Interest",
    "portfolio.calculator.converter": "Currency Converter",
    "portfolio.calculator.positionSize": "Position Size",
    "portfolio.calculator.fee": "Trading Fee Calculator",
    "portfolio.calculator.targetProfit": "Target Profit Calculator",
    "portfolio.calculator.valueA": "Value A",
    "portfolio.calculator.valueB": "Value B",
    "portfolio.calculator.sum": "Sum",
    "portfolio.calculator.difference": "Difference",
    "portfolio.calculator.product": "Product",
    "portfolio.calculator.quotient": "Quotient",
    "portfolio.calculator.base": "Base",
    "portfolio.calculator.percent": "Percent",
    "portfolio.calculator.result": "Result",
    "portfolio.calculator.revenue": "Revenue",
    "portfolio.calculator.cost": "Cost",
    "portfolio.calculator.initial": "Initial",
    "portfolio.calculator.final": "Final",
    "portfolio.calculator.principal": "Principal",
    "portfolio.calculator.rate": "Annual Rate",
    "portfolio.calculator.years": "Years",
    "portfolio.calculator.monthly": "Monthly Add",
    "portfolio.calculator.futureValue": "Future Value",
    "portfolio.calculator.from": "From",
    "portfolio.calculator.to": "To",
    "portfolio.calculator.converted": "Converted",
    "portfolio.calculator.capital": "Capital",
    "portfolio.calculator.riskPercent": "Risk %",
    "portfolio.calculator.entry": "Entry",
    "portfolio.calculator.stop": "Stop",
    "portfolio.calculator.feePercent": "Fee %",
    "portfolio.calculator.targetPercent": "Target %",

    "tradingPlan.badge": "Rencana eksekusi",
    "tradingPlan.title": "Trading Plan",
    "tradingPlan.subtitle": "Buat keputusan sebelum entry: coin apa, alasan trade, modal, risiko, position size, target profit, invalidasi, dan checklist mental supaya trade lebih disiplin.",
    "tradingPlan.decision": "Keputusan",
    "tradingPlan.checklistScore": "{score}/5 checklist terpenuhi sebelum entry.",
    "tradingPlan.conviction.wait": "Tunggu Dulu",
    "tradingPlan.conviction.valid": "Trade Valid",
    "tradingPlan.conviction.aggressive": "Setup Kuat",
    "tradingPlan.metric.risk": "Risiko",
    "tradingPlan.metric.ofCapital": "dari modal",
    "tradingPlan.metric.position": "Position size",
    "tradingPlan.metric.rr": "Risk reward",
    "tradingPlan.metric.targetHint": "Target 1 / Target 2",
    "tradingPlan.metric.maxLoss": "Max loss",
    "tradingPlan.metric.afterFees": "Termasuk estimasi fee",
    "tradingPlan.panel.asset": "Asset & Bias",
    "tradingPlan.panel.risk": "Modal & Risiko",
    "tradingPlan.panel.execution": "Ringkasan Eksekusi",
    "tradingPlan.panel.reason": "Alasan Trade",
    "tradingPlan.panel.checklist": "Checklist Sebelum Entry",
    "tradingPlan.field.coin": "Coin",
    "tradingPlan.field.market": "Kategori market",
    "tradingPlan.field.direction": "Arah trade",
    "tradingPlan.field.tradeType": "Tipe trade",
    "tradingPlan.field.setup": "Setup",
    "tradingPlan.field.capital": "Modal (USD)",
    "tradingPlan.field.riskPercent": "Risiko (%)",
    "tradingPlan.field.leverage": "Leverage",
    "tradingPlan.field.entry": "Entry price",
    "tradingPlan.field.stop": "Stop loss",
    "tradingPlan.field.fees": "Fee estimasi (%)",
    "tradingPlan.field.targetOne": "Target 1",
    "tradingPlan.field.targetTwo": "Target 2",
    "tradingPlan.field.margin": "Margin dibutuhkan",
    "tradingPlan.field.reason": "Kenapa trade ini?",
    "tradingPlan.field.invalidation": "Kapan plan batal?",
    "tradingPlan.field.notes": "Catatan tambahan",
    "tradingPlan.check.trend": "Trend dan struktur market sudah jelas",
    "tradingPlan.check.risk": "Risiko per trade masih sesuai aturan",
    "tradingPlan.check.news": "Tidak ada news besar yang berbahaya",
    "tradingPlan.check.liquidity": "Likuiditas dan spread aman untuk entry",
    "tradingPlan.check.emotion": "Entry bukan FOMO atau balas dendam",
    "tradingPlan.action.reset": "Reset",
    "tradingPlan.action.export": "Copy Plan",
    "tradingPlan.action.save": "Simpan Plan",
    "tradingPlan.toast.saved": "Trading plan tersimpan.",
    "tradingPlan.toast.reset": "Trading plan direset.",
    "tradingPlan.toast.exported": "Trading plan disalin ke clipboard.",
  ...
  en: {
    ...
    "portfolio.badge": "Asset management",
    "portfolio.title": "Portfolio Manager",
    "portfolio.subtitle": "Manage income, expenses, asset balances, transaction history, and portfolio calculators from your own Supabase data.",
    "portfolio.tab.overview": "Overview",
    "portfolio.tab.income": "Income",
    "portfolio.tab.expense": "Expense",
    "portfolio.tab.assets": "Assets",
    ...
    "portfolio.chart.income": "Income",
    "portfolio.chart.expense": "Expense",
    "portfolio.income.formTitle": "Add Income",
    "portfolio.income.formDescription": "Record real income without demo data.",
    "portfolio.income.listTitle": "Income List",
    "portfolio.income.emptyTitle": "No income yet",
    "portfolio.income.emptyDescription": "Income you save will appear here.",
    "portfolio.expense.formTitle": "Add Expense",
    "portfolio.expense.formDescription": "Record expenses from the relevant wallet or account.",
    "portfolio.expense.listTitle": "Expense List",
    "portfolio.expense.emptyTitle": "No expenses yet",
    "portfolio.expense.emptyDescription": "Expenses you save will appear here.",
    "portfolio.assets.title": "Assets",
    "portfolio.assets.formTitle": "Add Asset",
    "portfolio.assets.formDescription": "Track cash, bank, stablecoin, and major crypto balances.",
    "portfolio.assets.listTitle": "Asset Balances",
    "portfolio.assets.emptyTitle": "No assets yet",
    "portfolio.assets.emptyDescription": "Add your first balance to start seeing total assets.",
    "portfolio.assetType.cash": "Cash",
    "portfolio.assetType.bank": "Bank",
    "portfolio.assetType.idr": "IDR",
    "portfolio.assetType.usd": "USD",
    ...
    "portfolio.field.label": "Label",
    "portfolio.field.balance": "Balance",
    "portfolio.placeholder.category": "Transaction category",
    "portfolio.placeholder.wallet": "Wallet or account name",
    "portfolio.placeholder.source": "Income source",
    "portfolio.placeholder.note": "Optional note",
    "portfolio.placeholder.attachment": "Attachment URL",
    "portfolio.action.add": "Add",
    "portfolio.action.newIncome": "Add Income",
    "portfolio.action.csv": "CSV",
    "portfolio.action.excel": "Excel",
    "portfolio.action.print": "Print",
    "portfolio.action.previous": "Previous",
    "portfolio.action.next": "Next",
    "portfolio.action.undoDelete": "Undo Delete",
    "portfolio.history.title": "History",
    "portfolio.history.description": "Search, filter, sort, edit, delete, undo delete, export, and print transactions.",
    "portfolio.history.search": "Search transactions...",
    "portfolio.history.page": "Page {page} of {total}",
    "portfolio.history.deleted": "Deleted Transactions",
    "portfolio.filter.allTypes": "All types",
    "portfolio.filter.allCurrencies": "All currencies",
    "portfolio.sort.date": "Date",
    "portfolio.sort.amount": "Amount",
    "portfolio.sort.category": "Category",
    "portfolio.sort.type": "Type",
    "portfolio.sort.asc": "Ascending",
    "portfolio.sort.desc": "Descending",
    "portfolio.export.date": "Date",
    "portfolio.export.type": "Type",
    "portfolio.export.category": "Category",
    "portfolio.export.currency": "Currency",
    ...
    "portfolio.export.note": "Note",
    "portfolio.export.attachment": "Attachment",
    "portfolio.empty.monthlyTitle": "No monthly summary yet",
    "portfolio.empty.monthlyDescription": "The summary appears after transactions exist.",
    "portfolio.empty.transactionsTitle": "No transactions yet",
    "portfolio.empty.transactionsDescription": "Add income or expense to populate history.",
    "portfolio.error.title": "Portfolio is not ready",
    "portfolio.error.load": "Failed to load portfolio.",
    "portfolio.error.save": "Failed to save portfolio.",
    "portfolio.toast.required": "Complete the required fields first.",
    "portfolio.toast.created": "Portfolio data added.",
    "portfolio.toast.updated": "Portfolio data updated.",
    "portfolio.toast.deleted": "Portfolio data deleted.",
    "portfolio.toast.undo": "Delete undone.",
    "portfolio.calculator.basic": "Basic Calculator",
    "portfolio.calculator.percentage": "Percentage",
    "portfolio.calculator.pnl": "Profit & Loss",
    "portfolio.calculator.roi": "ROI",
    ...
    "tradingPlan.badge": "Execution planner",
    "tradingPlan.title": "Trading Plan",
    "tradingPlan.subtitle": "Make the decision before entry: which coin, why the trade exists, capital, risk, position size, targets, invalidation, and the mental checklist that keeps execution disciplined.",
    "tradingPlan.decision": "Decision",
    "tradingPlan.checklistScore": "{score}/5 checklist items are ready before entry.",
    "tradingPlan.conviction.wait": "Wait First",
    "tradingPlan.conviction.valid": "Valid Trade",
    "tradingPlan.conviction.aggressive": "Strong Setup",
    "tradingPlan.metric.risk": "Risk",
    "tradingPlan.metric.ofCapital": "of capital",
    "tradingPlan.metric.position": "Position size",
    "tradingPlan.metric.rr": "Risk reward",
    "tradingPlan.metric.targetHint": "Target 1 / Target 2",
    "tradingPlan.metric.maxLoss": "Max loss",
    "tradingPlan.metric.afterFees": "Including fee estimate",
    "tradingPlan.panel.asset": "Asset & Bias",
    "tradingPlan.panel.risk": "Capital & Risk",
    "tradingPlan.panel.execution": "Execution Summary",
    "tradingPlan.panel.reason": "Trade Reason",
    "tradingPlan.panel.checklist": "Pre-entry Checklist",
    "tradingPlan.field.coin": "Coin",
    "tradingPlan.field.market": "Market category",
    "tradingPlan.field.direction": "Trade direction",
    "tradingPlan.field.tradeType": "Trade type",
    "tradingPlan.field.setup": "Setup",
    "tradingPlan.field.capital": "Capital (USD)",
    "tradingPlan.field.riskPercent": "Risk (%)",
    "tradingPlan.field.leverage": "Leverage",
    "tradingPlan.field.entry": "Entry price",
    "tradingPlan.field.stop": "Stop loss",
    "tradingPlan.field.fees": "Estimated fee (%)",
    "tradingPlan.field.targetOne": "Target 1",
    "tradingPlan.field.targetTwo": "Target 2",
    "tradingPlan.field.margin": "Margin needed",
    "tradingPlan.field.reason": "Why this trade?",
    "tradingPlan.field.invalidation": "When is the plan invalid?",
    "tradingPlan.field.notes": "Extra notes",
    "tradingPlan.check.trend": "Trend and market structure are clear",
    "tradingPlan.check.risk": "Risk per trade follows the rule",
    "tradingPlan.check.news": "No dangerous major news nearby",
    "tradingPlan.check.liquidity": "Liquidity and spread are safe for entry",
    "tradingPlan.check.emotion": "Entry is not FOMO or revenge trading",
    "tradingPlan.action.reset": "Reset",
    "tradingPlan.action.export": "Copy Plan",
    "tradingPlan.action.save": "Save Plan",
    "tradingPlan.toast.saved": "Trading plan saved.",
    "tradingPlan.toast.reset": "Trading plan reset.",
    "tradingPlan.toast.exported": "Trading plan copied to clipboard.",
