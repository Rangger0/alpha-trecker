      ...
      <div className="relative h-full flex flex-col">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-[0.8rem] border border-alpha-border bg-[color:var(--alpha-surface)] text-[color:var(--alpha-main)]">
          ...
          <span className="rounded-full border border-[color:var(--alpha-secondary-border)] bg-[color:var(--alpha-secondary-soft)] px-2 py-0.5 text-[8px] uppercase tracking-[0.18em] text-[color:var(--alpha-main)] flex-shrink-0">
            Live
          </span>
        </div>
