...
const MOCK_PORTFOLIO_DATA: PortfolioData = {
  ...
  distribution: [
    { name: 'Ethereum', value: 5000, percentage: 40, color: 'var(--alpha-info)' },
    { name: 'BSC', value: 3000, percentage: 24, color: 'var(--alpha-highlight)' },
    { name: 'Polygon', value: 2500, percentage: 20, color: 'var(--alpha-warning)' },
    { name: 'Arbitrum', value: 2000, percentage: 16, color: 'var(--alpha-success)' },
  ],
  history: [
