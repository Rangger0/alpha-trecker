  ...
  return (
    <DashboardLayout>
      <div className="w-full px-6 py-6">
        ...
        <div 
          className="mb-8 p-6 rounded-xl border overflow-hidden relative group"
          style={{ borderLeft: `3px solid ${ecosystem.color}` }}
        >
          <div 
            className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
            style={{ background: `linear-gradient(135deg, ${ecosystem.color}08 0%, transparent 50%)` }}
          />
                  ...
                  <div className="relative">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span 
                          ...
                          style={{ color: ecosystem.color, borderColor: `${ecosystem.color}40`, background: `${ecosystem.color}10` }}
                        >
                          {project.type}
                        </span>
                      </div>
                    ...
                    <div className="mb-3">
                      ...
                      <div className={`h-1.5 rounded-full overflow-hidden ${isDark ? 'bg-[#0B0F14]' : 'bg-[#F3F4F6]'}`}>
                        <div className="h-full rounded-full transition-all duration-500" style={{ width: `${projectProgress}%`, backgroundColor: ecosystem.color }} />
                      </div>
                    </div>
